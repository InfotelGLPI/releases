...
/**
 * Class PluginReleasesTypeRisk
 */
class PluginReleasesTypeRisk extends CommonTreeDropdown {
   ...
   static function getMenuOptions($menu) {
      ...
      $plugin_page = '/plugins/releases/front/typerisk.php';
      ...
      if (Session::haveright(self::$rightname, UPDATE)) {
         $menu['options'][$itemtype]['links']['add'] = '/plugins/releases/front/typerisk.form.php\';';
      }
