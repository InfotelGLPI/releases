...
xgettext *.php */*.php */*.twig --copyright-holder='Release Development Team' --package-name='GLPI - Release plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
