...
CREATE TABLE `glpi_plugin_releases_releases` (
  ...
  `date_preproduction` DATETIME NULL DEFAULT NULL,
  `date_production` DATETIME NULL DEFAULT NULL,
  `begin_waiting_date` DATETIME NULL DEFAULT NULL,
...
CREATE TABLE `glpi_plugin_releases_reviews` (
   ...
   `name` varchar(255) collate utf8_unicode_ci default NULL,
   `plugin_releases_releases_id` int(11) NOT NULL default '0',
   `real_date_release` DATETIME NULL DEFAULT NULL,
