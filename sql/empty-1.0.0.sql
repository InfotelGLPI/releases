...
CREATE TABLE `glpi_plugin_releases_changes_releases` (
  `id` int(11) NOT NULL auto_increment,
  `plugin_release_releases_id` int(11) NOT NULL,
...
CREATE TABLE `glpi_plugin_releases_typerisks` (
   ...
   `comment` text collate utf8_unicode_ci,
    `plugin_release_typerisks_id` int(11)    NOT NULL                  DEFAULT '0',
...
CREATE TABLE `glpi_plugin_releases_typetests` (
   ...
   `name` varchar(255) collate utf8_unicode_ci default NULL,
   `comment` text collate utf8_unicode_ci,
    `plugin_release_typetests_id` int(11)    NOT NULL                  DEFAULT '0',
    `completename`                  text COLLATE utf8_unicode_ci,
    `level`                         int(11)    NOT NULL                  DEFAULT '0',
    `ancestors_cache`               longtext COLLATE utf8_unicode_ci,
    `sons_cache`                    longtext COLLATE utf8_unicode_ci,
...
CREATE TABLE `glpi_plugin_releases_deploytasks` (
  ...
  `date_mod` datetime DEFAULT NULL,
  `date_creation` datetime DEFAULT NULL,
  `plugin_release_deploytasktemplates_id` int(11) NOT NULL DEFAULT '0',
...
--    `groups_id_tech` int(11) NOT NULL DEFAULT '0',
   `content` longtext COLLATE utf8_unicode_ci,
   `plugin_release_rollbacktemplates_id` int(11) NOT NULL DEFAULT '0',
   `date_mod` datetime DEFAULT NULL,
   `date_creation` datetime DEFAULT NULL,
   PRIMARY KEY  (`id`),
   KEY `name` (`name`)
...
CREATE TABLE `glpi_plugin_releases_releasetemplates` (
  ...
  `date_mod` datetime default NULL,
  `date_creation` datetime DEFAULT NULL,
  `plugin_release_releasetemplates_id` int(11) NOT NULL DEFAULT '0',
  `is_deleted` tinyint(1) NOT NULL default '0',
