...
CREATE TABLE `glpi_plugin_releases_releases` (
  ...
  `service_shutdown` tinyint NOT NULL default '0',
  `service_shutdown_details` longtext COLLATE utf8mb4_unicode_ci,
  `hour_type` tinyint NOT NULL default '0',
  ...
  `status` int unsigned NOT NULL default '7',
...
CREATE TABLE `glpi_plugin_releases_changes_releases` (
  `id` int unsigned NOT NULL auto_increment,
  `plugin_releases_releases_id` int unsigned NOT NULL,
  `changes_id` int unsigned NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `glpi_plugin_releases_typerisks` (
   ...
   `comment` text collate utf8mb4_unicode_ci,
    `plugin_releases_typerisks_id` int unsigned    NOT NULL                  DEFAULT '0',
...
CREATE TABLE `glpi_plugin_releases_risks` (
   `id` int unsigned NOT NULL auto_increment,
   `entities_id` int unsigned NOT NULL default '0',
   `plugin_releases_releases_id` int unsigned NOT NULL default '0',
   `plugin_releases_typerisks_id` int unsigned NOT NULL default '0',
...
CREATE TABLE `glpi_plugin_releases_typetests` (
   ...
   `name` varchar(255) collate utf8mb4_unicode_ci default NULL,
   `comment` text collate utf8mb4_unicode_ci,
   `plugin_releases_typetests_id` int unsigned    NOT NULL                  DEFAULT '0',
   `completename`                  text COLLATE utf8mb4_unicode_ci,
   `level`                         int unsigned    NOT NULL                  DEFAULT '0',
   `ancestors_cache`               longtext COLLATE utf8mb4_unicode_ci,
   `sons_cache`                    longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `glpi_plugin_releases_tests` (
   ...
   `plugin_releases_releases_id` int unsigned NOT NULL default '0',
   `plugin_releases_typetests_id` int unsigned NOT NULL default '0',
   `plugin_releases_risks_id` int unsigned NOT NULL default '0',
   `state` int unsigned NOT NULL DEFAULT '1',
   `name` varchar(255) collate utf8mb4_unicode_ci default NULL,
   `users_id` int unsigned NOT NULL DEFAULT '0',
   `users_id_editor` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `glpi_plugin_releases_typedeploytasks` (
   ...
   `name` varchar(255) collate utf8mb4_unicode_ci default NULL,
   `comment` text collate utf8mb4_unicode_ci,
   `plugin_releases_typedeploytasks_id` int unsigned    NOT NULL                  DEFAULT '0',
   `completename`                  text COLLATE utf8mb4_unicode_ci,
   `level`                         int unsigned    NOT NULL                  DEFAULT '0',
   `ancestors_cache`               longtext COLLATE utf8mb4_unicode_ci,
   `sons_cache`                    longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `glpi_plugin_releases_deploytasks` (
  ...
  `date_mod` TIMESTAMP NULL DEFAULT NULL,
  `date_creation` TIMESTAMP NULL DEFAULT NULL,
  `plugin_releases_deploytasktemplates_id` int unsigned NOT NULL DEFAULT '0',
  `timeline_position` tinyint NOT NULL DEFAULT '0',
  `plugin_releases_deploytasks_id` int unsigned NOT NULL default 0,
  `level` int unsigned NOT NULL default 0,
   PRIMARY KEY  (`id`),
   KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `glpi_plugin_releases_deploytasktemplates` (
  ...
  `entities_id` int unsigned NOT NULL default '0',
  `name` varchar(255) collate utf8mb4_unicode_ci default NULL,
  `plugin_releases_releasetemplates_id` int unsigned NOT NULL DEFAULT '0',
  `plugin_releases_typedeploytasks_id` int unsigned NOT NULL DEFAULT '0',
  `plugin_releases_risks_id` int unsigned NOT NULL default '0',
  `state` int unsigned NOT NULL DEFAULT '1',
  `date` TIMESTAMP NULL DEFAULT NULL,
...
--    `groups_id_tech` int unsigned NOT NULL DEFAULT '0',
   `content` longtext COLLATE utf8mb4_unicode_ci,
   `plugin_releases_rollbacktemplates_id` int unsigned NOT NULL DEFAULT '0',
   `date_mod` TIMESTAMP NULL DEFAULT NULL,
   `date_creation` TIMESTAMP NULL DEFAULT NULL,
   PRIMARY KEY  (`id`),
   KEY `name` (`name`)
...
CREATE TABLE `glpi_plugin_releases_reviews` (
   ...
   `conforming_realization` tinyint NOT NULL default '0',
   `incident` tinyint NOT NULL default '0',
   `incident_description` longtext collate utf8mb4_unicode_ci,
   `date_lock` tinyint NOT NULL default '0',
   PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
VALUES (NULL, 'GlpiPlugin\\Releases\\Release', 1, 1, 0, 'central'),
(NULL, 'GlpiPlugin\\Releases\\Release', 8, 2, 0, 'central'),
(NULL, 'GlpiPlugin\\Releases\\Release', 2, 3, 0, 'central'),
(NULL, 'GlpiPlugin\\Releases\\Release', 4, 4, 0, 'central'),
(NULL, 'GlpiPlugin\\Releases\\Release', 5, 5, 0, 'central'),
(NULL, 'GlpiPlugin\\Releases\\Release', 6, 6, 0, 'central'),
(NULL, 'GlpiPlugin\\Releases\\Release', 7, 7, 0, 'central'),
(NULL, 'GlpiPlugin\\Releases\\Release', 18, 8, 0, 'central'),
(NULL, 'GlpiPlugin\\Releases\\Release', 9, 9, 0, 'central'),
(NULL, 'GlpiPlugin\\Releases\\Releasetemplate',4,3,0, 'central');
